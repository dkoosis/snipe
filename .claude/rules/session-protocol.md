...
3. Run `mage` (build + lint + test) to confirm green baseline
...
- For removals: batch by file/package, `mage qa` after each batch.

### Verification evidence

| Claim | Required proof |
|-------|---------------|
| "removed dead code" | `mage qa` passes, grep confirms symbol gone |
